...
router.post('/', uploadResume.single('file'), validateRequest(createResumeSchema), resumesController.createResume);
router.get('/:id', resumesController.getResumeById);
router.put('/:id', uploadResume.single('file'), validateRequest(updateResumeSchema), resumesController.updateResume);
